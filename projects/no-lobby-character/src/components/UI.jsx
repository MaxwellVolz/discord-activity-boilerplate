    ...
    >
      ...
      {stage === "lobby" && (
        <>
          {host ? (
            <button
              className="pointer-events-auto bg-gradient-to-br from-blue-500 to-green-500 hover:opacity-80 transition-all duration-200 px-12 py-4 rounded-lg font-black text-xl text-white drop-shadow-lg"
              onClick={startGame}
            >
              START
            </button>
            ...
            <p className="italic text-white">
              Waiting on the host...try yelling.
            </p>
          )}
        </>
      )}
